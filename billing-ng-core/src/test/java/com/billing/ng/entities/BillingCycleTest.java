...
public class BillingCycleTest {
    ...
    @Test
    public void testIsActiveForDate() throws Exception {
    }
    ...
    @Test
    public void testGetStartInstantOddPeriods() throws Exception {
        BillingCycle cycle = new BillingCycle();
    ...
    @Test
    public void testGetStartInstantLastDayOfMonth() throws Exception {
        BillingCycle cycle = new BillingCycle();
        cycle.setBillingPeriod(new BillingPeriod(BillingPeriod.Type.MONTH, 1));
    ...
    @Test
    public void testGetEndInstant() throws Exception {
        BillingCycle cycle = new BillingCycle();
        cycle.setBillingPeriod(new BillingPeriod(BillingPeriod.Type.MONTH, 1));
    ...
    @Test
    public void testGetEndInstantDefault() throws Exception {
        BillingCycle cycle = new BillingCycle();
        cycle.setBillingPeriod(new BillingPeriod(BillingPeriod.Type.MONTH, 1));
